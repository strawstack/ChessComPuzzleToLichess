(function(){ 
    ...
    function getWhiteToMove() {
        let highlight = document.querySelector("#board-board").querySelectorAll(".highlight").length;
        let whiteToMove = document.querySelector(".section-heading-title").innerText.indexOf("White") != -1;
        return (highlight > 0) ? whiteToMove : !whiteToMove;
    }
